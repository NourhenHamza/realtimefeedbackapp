...
"[project]/real-time-feedback-app/presenter-frontend/src/lib/api.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$real$2d$time$2d$feedback$2d$app$2f$presenter$2d$frontend$2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/real-time-feedback-app/presenter-frontend/node_modules/axios/lib/axios.js [app-client] (ecmascript)");
;
const API_BASE_URL = __TURBOPACK__imported__module__$5b$project$5d2f$real$2d$time$2d$feedback$2d$app$2f$presenter$2d$frontend$2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PUBLIC_PRESENTER_BACKEND_URL || 'http://localhost:8000';
const api = {
    /**
   * Fetch recent reactions
   */ async getReactions (sessionId, limit = 50) {
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$real$2d$time$2d$feedback$2d$app$2f$presenter$2d$frontend$2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`${API_BASE_URL}/api/presenter/reactions`, {
                params: {
   ...
   */ async getQuestions (sessionId) {
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$real$2d$time$2d$feedback$2d$app$2f$presenter$2d$frontend$2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`${API_BASE_URL}/api/presenter/questions`, {
                params: {
                    session_id: sessionId
                },
                timeout: 5000
   ...
   */ async healthCheck () {
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$real$2d$time$2d$feedback$2d$app$2f$presenter$2d$frontend$2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`${API_BASE_URL}/health`);
...
var __TURBOPACK__imported__module__$5b$project$5d2f$real$2d$time$2d$feedback$2d$app$2f$presenter$2d$frontend$2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/real-time-feedback-app/presenter-frontend/src/lib/api.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$real$2d$time$2d$feedback$2d$app$2f$presenter$2d$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/real-time-feedback-app/presenter-frontend/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
'use client';
...
function PresenterPage() {
    ...
    const [reactions, setReactions] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$real$2d$time$2d$feedback$2d$app$2f$presenter$2d$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    const [questions, setQuestions] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$real$2d$time$2d$feedback$2d$app$2f$presenter$2d$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    // Handle WebSocket messages
    const handleWebSocketMessage = (0, __TURBOPACK__imported__module__$5b$project$5d2f$real$2d$time$2d$feedback$2d$app$2f$presenter$2d$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
    ...
    const { status, reconnect, sendMessage, disconnect } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$real$2d$time$2d$feedback$2d$app$2f$presenter$2d$frontend$2f$src$2f$hooks$2f$useWebSocket$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useWebSocket"])({
        url: isSessionActive ? __TURBOPACK__imported__module__$5b$project$5d2f$real$2d$time$2d$feedback$2d$app$2f$presenter$2d$frontend$2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].getWebSocketUrl(sessionId) : '',
                ...
                const loadInitialData = {
                    "PresenterPage.useEffect.loadInitialData": async ()=>{
                        const [reactionsData, questionsData] = await Promise.all([
                            __TURBOPACK__imported__module__$5b$project$5d2f$real$2d$time$2d$feedback$2d$app$2f$presenter$2d$frontend$2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].getReactions(sessionId, 50),
                            __TURBOPACK__imported__module__$5b$project$5d2f$real$2d$time$2d$feedback$2d$app$2f$presenter$2d$frontend$2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].getQuestions(sessionId)
                        ]);
    ...
    if (!isSessionActive) {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$real$2d$time$2d$feedback$2d$app$2f$presenter$2d$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("main", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$real$2d$time$2d$feedback$2d$app$2f$presenter$2d$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("form", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$real$2d$time$2d$feedback$2d$app$2f$presenter$2d$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$real$2d$time$2d$feedback$2d$app$2f$presenter$2d$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("label", {
                                        htmlFor: "sessionId",
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$real$2d$time$2d$feedback$2d$app$2f$presenter$2d$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                                        type: "text",
                                        id: "sessionId",
                                        value: sessionId,
...
//# sourceMappingURL=real-time-feedback-app_presenter-frontend_src_36c06c45._.js.map